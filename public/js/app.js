import { api } from './api.js?v=1.1.3';
import { store } from './storage.js?v=1.1.3';
import { buildPersonalizedHome } from './recommend.js?v=1.1.3';
...
async function ensurePlayerModules() {
  ...
  if (!playerModulesPromise) {
    playerModulesPromise = Promise.all([
      import('./player.js?v=1.1.3'),
      import('./player-ui.js?v=1.1.3'),
